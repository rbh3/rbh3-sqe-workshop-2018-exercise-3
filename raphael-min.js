        ...
        void 0 ===
          (n = function(t) {
            ...
            var r,
              ...
              f = "concat",
              p =
                "ontouchstart" in l.win ||
                (l.win.DocumentTouch && l.doc instanceof DocumentTouch),
              d = "",
              g = " ",
              x = String,
              v = "split",
            ...
            (e.svg = !(e.vml = "VML" == e.type)),
              ...
              (e.snapTo = function(t, r, i) {
                if (((i = e.is(i, "finite") ? i : 10), e.is(t, T))) {
            ...
            (e.getRGB = ht(function(t) {
              ...
              (e.parseTransformString = ht(function(t) {
                ...
                var r = [];
                return (
                  e.is(t, T) && e.is(t[0], T) && (r = mt(t)),
                  r.length ||
                    x(t).replace(Y, function(t, e, i) {
                      var n = [];
                      b.call(e);
                      i.replace(W, function(t, e) {
                        e && n.push(+e);
                      }),
                        r.push([e][f](n));
                    }),
                ...
                for (var x = 0; x < h; x++) {
                  ...
                  if (S) {
                    ...
                    var A =
                      ...
                      T = m.t + B((S[C] - m[C]) / (b[C] - m[C])) * (b.t - m.t);
                    A >= 0 &&
                      A <= 1.001 &&
                      T >= 0 &&
                      T <= 1.001 &&
                      (i
                        ? p++
                        : p.push({ x: S.x, y: S.y, t1: k(A, 1), t2: k(T, 1) }));
                  }
                }
              return p;
            }
            function vt(t, r, i) {
              ...
              for (
                ...
                if ("M" == v[0]) (n = l = v[1]), (a = h = v[2]);
                  ...
                  "C" == v[0]
                    ? ((n = (f = [n, a].concat(v.slice(1)))[6]), (a = f[7]))
                  ...
                  for (var y = 0, m = r.length; y < m; y++) {
                    ...
                    if ("M" == b[0]) (s = u = b[1]), (o = c = b[2]);
                      ...
                      "C" == b[0]
                        ? ((s = (p = [s, o].concat(b.slice(1)))[6]), (o = p[7]))
              ...
              (e._removedFactory = function(e) {
                return function() {
                  t(
                    "raphael.log",
                    null,
                    "Rapha�l: you are calling to method �" +
                      e +
                      "� of removed object",
                    e
                  );
              ...
              Bt = function(t, e, r, i, n, a, s, o, l, h) {
                ...
                if (h) (T = h[0]), (M = h[1]), (C = h[2]), (A = h[3]);
                  ...
                  var b = r * r,
                    ...
                    C = (k * r * y) / i + (t + o) / 2,
                    A = (k * -i * x) / r + (e + l) / 2,
                    T = _.asin(((e - A) / i).toFixed(9)),
                    M = _.asin(((l - A) / i).toFixed(9));
                  (T = t < C ? S - T : T),
                    (M = o < C ? S - M : M),
                    T < 0 && (T = 2 * S + T),
                    M < 0 && (M = 2 * S + M),
                ...
                if (B(E) > c) {
                  ...
                  (M = T + c * (s && M > T ? 1 : -1)),
                    (o = C + r * _.cos(M)),
                    (l = A + i * _.sin(M)),
                    (d = Bt(o, l, r, i, n, 0, s, L, P, [M, N, C, A]));
                }
                E = M - T;
                var z = _.cos(T),
                  F = _.sin(T),
            ...
            (Yt.drag = function(r, i, n, a, s, o) {
              ...
              (i.path = function(t) {
                t && !e.is(t, "string") && !e.is(t[0], T) && (t += d);
            ...
            function ae(r, i, a, s, l, h) {
              ...
              if (u) {
                if (c) (c.initstatus = s), (c.start = new Date() - c.ms * s);
                  ...
                  var Y = u.easing,
                    W = e.easing_formulas[Y];
                  if (!W)
                    if ((W = x(Y).match(L)) && 5 == W.length) {
                      var G = W;
                      W = function(t) {
            ...
            for (var ce in ((ue.push = function() {
              for (var t, e, r = 0, i = arguments.length; r < i; r++)
                !(t = arguments[r]) ||
                  (t.constructor != Yt.constructor && t.constructor != he) ||
              ...
              (i.print = function(t, r, i, a, s, o, l, h) {
                ...
                if ((e.is(a, "string") && (a = this.getFont(a)), a)) {
                  ...
                  for (
                    ...
                    if ("\n" == c[C]) (f = 0), (T = 0), (p = 0), (_ += b * h);
                    else {
                      var A = (p && a.glyphs[c[C - 1]]) || {},
                        T = a.glyphs[c[C]];
                      (f += p
                        ? (A.w || a.w) + ((A.k && A.k[c[C]]) || 0) + a.w * l
                        : 0),
                        (p = 1);
                    }
                    T &&
            ...
            if (!t || t.vml) {
              ...
              var k,
                ...
                C = function(n, l) {
                  ...
                  if (
                    ("arrow-start" in l && B(A, l["arrow-start"]),
                    "arrow-end" in l && B(A, l["arrow-end"], 1),
                    null != l.opacity ||
                      null != l.fill ||
                      null != l.src ||
                      null != l.stroke ||
                    ...
                    O.on && l.stroke && (O.color = Y.hex),
                      (q =
                        ...
                        ((+g.opacity + 1 || 2) - 1) *
                        ((+Y.o + 1 || 2) - 1));
                    var W = 0.75 * (i(l["stroke-width"]) || 1);
                    if (
                      ((q = o(s(q, 0), 1)),
                      null == l["stroke-width"] && (W = g["stroke-width"]),
                      l["stroke-width"] && (O.weight = W),
                      W && W < 1 && (q *= W) && (O.weight = 1),
                      (O.opacity = q),
                      l["stroke-linejoin"] &&
                  ...
                  if ("text" == A.type) {
                    A.paper.canvas.style.display = f;
                    var H = A.paper.span,
                    ...
                    (v = H.style),
                      ...
                      (v.fontSize = 100 * X + "px"),
                      A.textpath.string &&
                        (H.innerHTML = r(A.textpath.string)
                          .replace(/</g, "&#60;")
                          .replace(/&/g, "&#38;")
                          .replace(/\n/g, "<br>"));
                    var U = H.getBoundingClientRect();
                    (A.W = g.w = (U.right - U.left) / 100),
                      (A.H = g.h = (U.bottom - U.top) / 100),
                      (A.X = g.x),
                      (A.Y = g.y + A.H / 2),
                      ("x" in l || "y" in l) &&
                        (A.path.v = t.format(
                  ...
                  if ("path" == i.type) {
                    ...
                    if (
                      ...
                      var S = "raphael-marker-" + w,
                        A = "raphael-marker-" + v + w + k + B + "-obj" + i.id;
                      ...
                      M
                        ? (g[A]++, (T = M.getElementsByTagName("use")[0]))
                        : ((M = x(x("marker"), {
                            id: A,
                            markerHeight: B,
                            markerWidth: k,
                  ...
                  (this.bottom = this.top = null),
                    (this.desc = x("desc")).appendChild(
                      t._g.doc.createTextNode(
                        "Created with Rapha�l " + t.version
                      )
                    ),
